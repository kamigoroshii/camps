...
from app.api.v1.endpoints import auth, users, requests, documents, notifications, dashboard, rag, mongo_auth, dev_tools, test_endpoints, scholarship_verification_simple
...
api_router.include_router(scholarship_verification_simple.router, prefix="/scholarship-verification", tags=["Scholarship Verification"])
